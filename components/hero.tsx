...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 text-center max-w-4xl px-4 sm:px-6 md:px-8 py-8 sm:py-12">
        <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 glassmorphism">
          <Sparkles size={14} className="text-accent sm:w-4 sm:h-4" />
          <span className="text-xs sm:text-sm tracking-wide">NEW COLLECTION 2025</span>
        </div>

        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight text-balance neon-accent">
          Redefine Your Style
        </h1>

        <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 text-balance max-w-2xl mx-auto text-white">
          Experience ultra-modern luxury with futuristic design. Crafted for those who dare to be different.
        </p>
